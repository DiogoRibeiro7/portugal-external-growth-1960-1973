...
def build_bpstat_registry_review(frame: pd.DataFrame) -> str:
    ...
    return "\n".join(
        [
            ...
            "",
            "Configured extraction series are accepted only as source-preserving",
            "context data. Territorial definitions, methodological breaks, and",
            "historical coverage caveats remain active in downstream outputs.",
            "",
            "Candidate details:",
            *candidate_lines,
            "",
